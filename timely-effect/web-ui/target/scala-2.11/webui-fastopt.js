...
$c_Lcalculator_Calculator$.prototype.eval__Lcalculator_Expr__sci_Map__D = (function(expr, references) {
  _eval: while (true) {
    ...
    if ($is_Lcalculator_Literal(x1)) {
      ...
      var v$2 = x3.name$2;
      var temp$expr = this.getReferenceExpr__p1__T__sci_Map__Lcalculator_Expr(v$2, references);
      var this$1 = references;
      var p = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(v$1) {
...
$c_Lcalculator_Polynomial$.prototype.computeSolutions__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal = (function(a, b, c, delta) {
  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(a$2, b$2, delta$1) {
    return (function() {
      var dVal = $uD(delta$1.apply__O());
      if ((dVal < 0)) {
        return $as_sci_Set($m_s_Predef$().Set$2.apply__sc_Seq__sc_GenTraversable($m_sci_Nil$()))
      } else {
        var aVal = $uD(a$2.apply__O());
        var bVal = $uD(b$2.apply__O());
        var array = [(((-bVal) + $uD($g.Math.sqrt(dVal))) / (2 * aVal)), (((-bVal) - $uD($g.Math.sqrt(dVal))) / (2 * aVal))];
...
$c_Lcalculator_Polynomial$.prototype.computeDelta__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal = (function(a, b, c) {
  return new $c_Lcalculator_Signal().init___F0(new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(a$1, b$1, c$1) {
    return (function() {
...
$c_Lcalculator_TweetLength$.prototype.tweetRemainingCharsCount__Lcalculator_Signal__Lcalculator_Signal = (function(tweetText) {
  return new $c_Lcalculator_Signal().init___F0(new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(tweetText$1) {
    return (function() {
...
$c_Lcalculator_TweetLength$.prototype.colorForRemainingCharsCount__Lcalculator_Signal__Lcalculator_Signal = (function(remainingCharsCount) {
  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(remainingCharsCount$1) {
    return (function() {
      var re = $uI(remainingCharsCount$1.apply__O());
      return ((re >= 15) ? "green" : (((re >= 0) && (re <= 14)) ? "orange" : "red"))
    })
  })(remainingCharsCount));
  return new $c_Lcalculator_Signal().init___F0(expr)
});
...
$c_Lcalculator_Calculator$$anonfun$computeValues$1.prototype.apply__T2__T2 = (function(x0$1) {
  if ((x0$1 !== null)) {
    var varName = $as_T(x0$1.$$und1$f);
    var signalExpr = $as_Lcalculator_Signal(x0$1.$$und2$f);
    $m_Lcalculator_Signal$();
    var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(arg$outer, signalExpr$1) {
      return (function() {
...
/** @constructor */
function $c_sc_MapLike$FilteredKeys() {
...
/** @constructor */
function $h_sc_MapLike$FilteredKeys() {
  /*<skip>*/
}
...
$c_sc_MapLike$FilteredKeys.prototype.foreach__F1__V = (function(f) {
  this.$$outer$f.foreach__F1__V(new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function($this, f$1) {
    return (function(kv$2) {
      var kv = $as_T2(kv$2);
      return ($uZ($this.p$4.apply__O__O(kv.$$und1$f)) ? f$1.apply__O__O(kv) : (void 0))
    })
  })(this, f)))
});
...
$c_sc_MapLike$FilteredKeys.prototype.iterator__sc_Iterator = (function() {
  ...
  var p = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function($this) {
    return (function(kv$2) {
      var kv = $as_T2(kv$2);
      return $uZ($this.p$4.apply__O__O(kv.$$und1$f))
    })
  })(this));
...
var $d_sci_MapLike$$anon$1 = new $TypeData().initClass({
